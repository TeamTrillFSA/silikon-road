...
describe('Product', () => {
  describe('visual content', () => {
    ...
    it('includes "Description" as p', () => {
      expect(productWrapper.find('p').text()).to.equal('Product Description');
    });
    ...
    it('is not hardcoded', () => {
      ...
      const differentProductWrapper =
        shallow(<Product product={aDifferentProduct} match={match} />);
      ...
      expect(differentProductWrapper.find('p').text()).to.equal('Product Description 2');
    });
  });
});
